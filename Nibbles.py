...
class Board(Canvas):
    ...
    def __init__(self, parent):
        Canvas(width=WIDTH, height=HEIGHT, background="black", highlightthickness=0)
        self.parent = parent
        self.initGame()
        self.pack()
    ...
    def initGame(self):
        ...
        try:
            self.idot = Image.new("RGB", (10, 10), (255, 0, 0))
            self.dot = ImageTk.PhotoImage(self.idot)
            self.ihead = Image.new("RGB", (10, 10), (255, 255, 0))
            self.head = ImageTk.PhotoImage(self.ihead)
            self.iapple = Image.new("RGB", (10, 10), (255, 255, 255))
